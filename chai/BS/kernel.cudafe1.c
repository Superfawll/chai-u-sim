...
enum _ZNSt12__is_integerIeEUt_E { _ZNSt12__is_integerIeE7__valueE};
# 139 "/usr/include/c++/4.6/bits/cpp_type_traits.h" 3
...
extern  __attribute__((__weak__)) /* COMDAT group: memcpy */ __inline__ void *__attribute__((__always_inline__)) memcpy(void *__restrict__, const void *__restrict__, size_t);
# 76 "/usr/include/x86_64-linux-gnu/bits/string3.h" 3
extern  __attribute__((__weak__)) /* COMDAT group: memset */ __inline__ void *__attribute__((__always_inline__)) memset(void *, int, size_t);
# 189 "/usr/include/time.h" 3
extern clock_t clock(void);
# 102 "/usr/include/x86_64-linux-gnu/bits/stdio2.h" 3
extern  __attribute__((__weak__)) /* COMDAT group: printf */ __inline__ int __attribute__((__always_inline__)) printf(const char *__restrict__, ...);
# 66 "/usr/local/cuda/bin/../include/math_functions.h"
extern int __attribute__((__const__)) abs(int);

extern long __attribute__((__const__)) labs(long);

extern long long __attribute__((__const__)) llabs(long long);

extern double __attribute__((__const__)) fabs(double);

extern float __attribute__((__const__)) fabsf(float);
...
extern float __attribute__((__const__)) fminf(float, float);

extern double __attribute__((__const__)) fmin(double, double);
...
extern float __attribute__((__const__)) fmaxf(float, float);

extern double __attribute__((__const__)) fmax(double, double);
...
extern double __attribute__((__const__)) floor(double);

extern float __attribute__((__const__)) floorf(float);
...
extern double __attribute__((__const__)) round(double);

extern float __attribute__((__const__)) roundf(float);
...
extern double __attribute__((__const__)) ceil(double);

extern float __attribute__((__const__)) ceilf(float);


extern double __attribute__((__const__)) trunc(double);

extern float __attribute__((__const__)) truncf(float);
...
extern double __attribute__((__const__)) copysign(double, double);

extern float __attribute__((__const__)) copysignf(float, float);


extern double __attribute__((__const__)) nextafter(double, double);

extern float __attribute__((__const__)) nextafterf(float, float);


extern double __attribute__((__const__)) nan(const char *);

extern float __attribute__((__const__)) nanf(const char *);


extern int __attribute__((__const__)) __isinf(double);

extern int __attribute__((__const__)) __isinff(float);


extern int __attribute__((__const__)) __isnan(double);

extern int __attribute__((__const__)) __isnanf(float);
# 419 "/usr/local/cuda/bin/../include/math_functions.h"
extern int __attribute__((__const__)) __finite(double);

extern int __attribute__((__const__)) __finitef(float);
# 431 "/usr/local/cuda/bin/../include/math_functions.h"
extern double fma(double, double, double);

extern float fmaf(float, float, float);
# 443 "/usr/local/cuda/bin/../include/math_functions.h"
extern int __attribute__((__const__)) __isinfl(long double);

extern int __attribute__((__const__)) __isnanl(long double);
# 455 "/usr/local/cuda/bin/../include/math_functions.h"
extern int __attribute__((__const__)) __finitel(long double);
# 127 "/usr/include/x86_64-linux-gnu/bits/mathinline.h" 3
extern  /* COMDAT group: __signbitf */ __inline__ int __attribute__((__always_inline__)) __attribute__((__const__)) __signbitf(float);
# 139 "/usr/include/x86_64-linux-gnu/bits/mathinline.h" 3
extern  /* COMDAT group: __signbit */ __inline__ int __attribute__((__always_inline__)) __attribute__((__const__)) __signbit(double);
# 151 "/usr/include/x86_64-linux-gnu/bits/mathinline.h" 3
extern  /* COMDAT group: __signbitl */ __inline__ int __attribute__((__always_inline__)) __attribute__((__const__)) __signbitl(long double);
# 124 "kernel.cu"
extern cudaError_t _Z19call_Bezier_surfaceiiifiiiiiP3XYZS0_Pi(int, int, int, float, int, int, int, int, int, XYZ *, XYZ *, int *);
extern int __cudaSetupArg();
extern int __cudaLaunch();
extern int __cudaRegisterBinary();
extern int __cudaRegisterEntry();
static void __sti___14_kernel_cpp1_ii_b5b693b1(void) __attribute__((__constructor__));
# 127 "/usr/include/x86_64-linux-gnu/bits/mathinline.h" 3
extern  /* COMDAT group: __signbitf */ __inline__ int __attribute__((__always_inline__)) __attribute__((__const__)) __signbitf( float __x)
{

 int __cuda_local_var_17616_7_non_const___m;
__asm("pmovmskb %1, %0" : "=r" (__cuda_local_var_17616_7_non_const___m) : "x" (__x));
return (int)((__cuda_local_var_17616_7_non_const___m & 8) != 0);
...
extern  /* COMDAT group: __signbit */ __inline__ int __attribute__((__always_inline__)) __attribute__((__const__)) __signbit( double __x)
{

 int __cuda_local_var_17628_7_non_const___m;
__asm("pmovmskb %1, %0" : "=r" (__cuda_local_var_17628_7_non_const___m) : "x" (__x));
return (int)((__cuda_local_var_17628_7_non_const___m & 128) != 0);
...
extern  /* COMDAT group: __signbitl */ __inline__ int __attribute__((__always_inline__)) __attribute__((__const__)) __signbitl( long double __x)
{
 union _ZZ10__signbitlEUt_ __cuda_local_var_17639_56_non_const___u;
# 153 "/usr/include/x86_64-linux-gnu/bits/mathinline.h" 3
(__cuda_local_var_17639_56_non_const___u.__l) = __x;
return (int)(((((__cuda_local_var_17639_56_non_const___u.__i))[2]) & 32768) != 0);
}
# 124 "kernel.cu"
cudaError_t _Z19call_Bezier_surfaceiiifiiiiiP3XYZS0_Pi( int blocks,  int threads,  int n_tasks,  float alpha, 
...
{  unsigned __T22;
 ...
 unsigned __T24;
# 131 "kernel.cu"
 dim3 __cuda_local_var_29683_10_non_const_dimGrid;
 dim3 __cuda_local_var_29684_10_non_const_dimBlock;
# 139 "kernel.cu"
 cudaError_t __cuda_local_var_29691_17_non_const_err;
# 131 "kernel.cu"
{ __T22 = ((unsigned)blocks); { (__cuda_local_var_29683_10_non_const_dimGrid.x) = __T22; (__cuda_local_var_29683_10_non_const_dimGrid.y) = 1U; (__cuda_local_var_29683_10_non_const_dimGrid.z) = 1U; } }
{ __T23 = ((unsigned)threads); __T24 = ((unsigned)threads); { (__cuda_local_var_29684_10_non_const_dimBlock.x) = __T23; (__cuda_local_var_29684_10_non_const_dimBlock.y) = __T24; (__cuda_local_var_29684_10_non_const_dimBlock.z) = 1U; } }
(cudaConfigureCall(__cuda_local_var_29683_10_non_const_dimGrid, __cuda_local_var_29684_10_non_const_dimBlock, ((size_t)l_mem_size), ((cudaStream_t)0))) ? ((void)0) : (__device_stub__Z14Bezier_surfaceifiiiiP3XYZS0_Pi(n_tasks, alpha, in_size_i, in_size_j, out_size_i, out_size_j, d_in, d_out, worklist));
# 139 "kernel.cu"
__cuda_local_var_29691_17_non_const_err = (cudaGetLastError());
return __cuda_local_var_29691_17_non_const_err;
}
static void __sti___14_kernel_cpp1_ii_b5b693b1(void) {   }
