...
# 43 "kernel.cu"
extern int _Z18gen_model_paramGPUiiiiiiiiPf(int, int, int, int, int, int, int, int, float *);
# 67 "kernel.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z19RANSAC_kernel_blockiiififPfP10flowvectorPiS2_S2_S2_S2_(int, int, int, float, int, float, float *, flowvector *, int *, int *, int *, int *, int *);
# 77 "kernel.cu"
...
{
# 44 "kernel.cu"
 float __cuda_local_var_29600_11_non_const_temp;
# 46 "kernel.cu"
__cuda_local_var_29600_11_non_const_temp = ((float)((((vx1 * (vx1 - (2 * vx2))) + (vx2 * vx2)) + (vy1 * vy1)) - (vy2 * ((2 * vy1) - vy2))));
# 47 "kernel.cu"
if (__cuda_local_var_29600_11_non_const_temp == (0.0F))
# 47 "kernel.cu"
{
# 48 "kernel.cu"
return 0;
...
# 50 "kernel.cu"
(model_param[0]) = (fdividef(((float)(((vx1 * ((((((-vx2) * x1) + (vx1 * x2)) - (vx2 * x2)) + (vy2 * y1)) - (vy2 * y2))) + (vy1 * ((((((-vy2) * x1) + (vy1 * x2)) - (vy2 * x2)) - (vx2 * y1)) + (vx2 * y2)))) + (x1 * ((vy2 * vy2) + (vx2 * vx2))))), __cuda_local_var_29600_11_non_const_temp));
# 54 "kernel.cu"
(model_param[1]) = (fdividef(((float)(((vx2 * (((((vy1 * x1) - (vy1 * x2)) - (vx1 * y1)) + (vx2 * y1)) - (vx1 * y2))) + (vy2 * ((((((-vx1) * x1) + (vx1 * x2)) - (vy1 * y1)) + (vy2 * y1)) - (vy1 * y2)))) + (y2 * ((vx1 * vx1) + (vy1 * vy1))))), __cuda_local_var_29600_11_non_const_temp));
# 59 "kernel.cu"
__cuda_local_var_29600_11_non_const_temp = ((float)((((x1 * (x1 - (2 * x2))) + (x2 * x2)) + (y1 * (y1 - (2 * y2)))) + (y2 * y2)));
# 60 "kernel.cu"
if (__cuda_local_var_29600_11_non_const_temp == (0.0F))
# 60 "kernel.cu"
{
...
# 63 "kernel.cu"
(model_param[2]) = (fdividef(((float)(((x1 - x2) * (vx1 - vx2)) + ((y1 - y2) * (vy1 - vy2)))), __cuda_local_var_29600_11_non_const_temp));
# 64 "kernel.cu"
(model_param[3]) = (fdividef(((float)(((x1 - x2) * (vy1 - vy2)) + ((y2 - y1) * (vx1 - vx2)))), __cuda_local_var_29600_11_non_const_temp));
# 65 "kernel.cu"
return 1;
# 66 "kernel.cu"
}
# 67 "kernel.cu"
__attribute__((global)) __attribute__((__used__)) void _Z19RANSAC_kernel_blockiiififPfP10flowvectorPiS2_S2_S2_S2_(
# 68 "kernel.cu"
...
# 75 "kernel.cu"
 Partitioner __T24;
# 78 "kernel.cu"
 int *__cuda_local_var_29634_10_non_const_outlier_block_count;
# 80 "kernel.cu"
 int *__cuda_local_var_29636_10_non_const_l_tmp;
# 84 "kernel.cu"
 Partitioner __cuda_local_var_29640_17_non_const_p;
# 89 "kernel.cu"
 int __cuda_local_var_29645_15_non_const_tx;
# 90 "kernel.cu"
 int __cuda_local_var_29646_15_non_const_bx;
# 91 "kernel.cu"
 int __cuda_local_var_29647_15_non_const_num_blocks;
# 93 "kernel.cu"
 float __cuda_local_var_29649_11_non_const_vx_error;
# 93 "kernel.cu"
 float __cuda_local_var_29649_21_non_const_vy_error;
# 94 "kernel.cu"
 int __cuda_local_var_29650_9_non_const_outlier_local_count;
# 78 "kernel.cu"
__cuda_local_var_29634_10_non_const_outlier_block_count = l_mem;
# 80 "kernel.cu"
__cuda_local_var_29636_10_non_const_l_tmp = (__cuda_local_var_29634_10_non_const_outlier_block_count + 1);
# 84 "kernel.cu"
__cuda_local_var_29640_17_non_const_p = ((((__T24.n_tasks) = n_tasks) , ((void)(((((double)alpha) >= (0.0)) && (((double)alpha) <= (1.0))) ? ((void)(((__T24.cut) = ((int)(__float2int_rz(((float)(((float)(__T24.n_tasks)) * alpha)))))) , ((void)((__T24.strategy) = 0)))) : ((void)((((__T24.strategy) = 1) , ((void)((__T24.worklist) = worklist))) , ((void)((__T24.tmp) = __cuda_local_var_29636_10_non_const_l_tmp))))))) , __T24);
# 89 "kernel.cu"
__cuda_local_var_29645_15_non_const_tx = ((int)(threadIdx.x));
# 90 "kernel.cu"
__cuda_local_var_29646_15_non_const_bx = ((int)(blockIdx.x));
# 91 "kernel.cu"
__cuda_local_var_29647_15_non_const_num_blocks = ((int)(gridDim.x));
# 94 "kernel.cu"
__cuda_local_var_29650_9_non_const_outlier_local_count = 0;
# 94 "kernel.cu"
{
# 94 "kernel.cu"
 int *__T25;
...
# 97 "kernel.cu"
 int iter;
# 97 "kernel.cu"
iter = ((((__cuda_local_var_29640_17_non_const_p.strategy) == 1) ? ((void)((((((threadIdx.y) == 0U) && ((threadIdx.x) == 0U)) ? ((void)(((__cuda_local_var_29640_17_non_const_p.tmp)[0]) = ((__T25 = (__cuda_local_var_29640_17_non_const_p.worklist)) , (__iAtomicAdd(__T25, 1))))) : ((void)0)) , ((void)(__syncthreads()))) , ((void)((__cuda_local_var_29640_17_non_const_p.current) = ((__cuda_local_var_29640_17_non_const_p.tmp)[0]))))) : ((void)((__cuda_local_var_29640_17_non_const_p.current) = ((int)(((unsigned)(__cuda_local_var_29640_17_non_const_p.cut)) + (blockIdx.x)))))) , (__cuda_local_var_29640_17_non_const_p.current));
# 97 "kernel.cu"
for (; ((char)((((const Partitioner *)(&__cuda_local_var_29640_17_non_const_p))->current) < (((const Partitioner *)(&__cuda_local_var_29640_17_non_const_p))->n_tasks))); iter = ((((__cuda_local_var_29640_17_non_const_p.strategy) == 1) ? ((void)((((((threadIdx.y) == 0U) && ((threadIdx.x) == 0U)) ? ((void)(((__cuda_local_var_29640_17_non_const_p.tmp)[0]) = ((__T26 = (__cuda_local_var_29640_17_non_const_p.worklist)) , (__iAtomicAdd(__T26, 1))))) : ((void)0)) , ((void)(__syncthreads()))) , ((void)((__cuda_local_var_29640_17_non_const_p.current) = ((__cuda_local_var_29640_17_non_const_p.tmp)[0]))))) : ((void)((__cuda_local_var_29640_17_non_const_p.current) = ((int)(((unsigned)(__cuda_local_var_29640_17_non_const_p.current)) + (gridDim.x)))))) , (__cuda_local_var_29640_17_non_const_p.current)))
# 97 "kernel.cu"
{
# 97 "kernel.cu"
{
# 99 "kernel.cu"
 float *__cuda_local_var_29655_16_non_const_model_param;
# 99 "kernel.cu"
__cuda_local_var_29655_16_non_const_model_param = (model_param_local + (4 * iter));
# 103 "kernel.cu"
if (__cuda_local_var_29645_15_non_const_tx == 0)
# 103 "kernel.cu"
{
# 106 "kernel.cu"
 int __cuda_local_var_29662_17_non_const_rand_num;
# 107 "kernel.cu"
 flowvector __cuda_local_var_29663_24_non_const_fv[2];
# 112 "kernel.cu"
 int __cuda_local_var_29668_17_non_const_ret;
# 113 "kernel.cu"
 int __cuda_local_var_29669_17_non_const_vx1;
# 114 "kernel.cu"
 int __cuda_local_var_29670_17_non_const_vy1;
# 115 "kernel.cu"
 int __cuda_local_var_29671_17_non_const_vx2;
# 116 "kernel.cu"
 int __cuda_local_var_29672_17_non_const_vy2;
# 104 "kernel.cu"
(__cuda_local_var_29634_10_non_const_outlier_block_count[0]) = 0;
# 106 "kernel.cu"
__cuda_local_var_29662_17_non_const_rand_num = (random_numbers[((iter * 2) + 0)]);
# 108 "kernel.cu"
((__cuda_local_var_29663_24_non_const_fv)[0]) = (flowvectors[__cuda_local_var_29662_17_non_const_rand_num]);
# 109 "kernel.cu"
__cuda_local_var_29662_17_non_const_rand_num = (random_numbers[((iter * 2) + 1)]);
# 110 "kernel.cu"
((__cuda_local_var_29663_24_non_const_fv)[1]) = (flowvectors[__cuda_local_var_29662_17_non_const_rand_num]);
# 112 "kernel.cu"
__cuda_local_var_29668_17_non_const_ret = 0;
# 113 "kernel.cu"
__cuda_local_var_29669_17_non_const_vx1 = ((((__cuda_local_var_29663_24_non_const_fv)[0]).vx) - (((__cuda_local_var_29663_24_non_const_fv)[0]).x));
# 114 "kernel.cu"
__cuda_local_var_29670_17_non_const_vy1 = ((((__cuda_local_var_29663_24_non_const_fv)[0]).vy) - (((__cuda_local_var_29663_24_non_const_fv)[0]).y));
# 115 "kernel.cu"
__cuda_local_var_29671_17_non_const_vx2 = ((((__cuda_local_var_29663_24_non_const_fv)[1]).vx) - (((__cuda_local_var_29663_24_non_const_fv)[1]).x));
# 116 "kernel.cu"
__cuda_local_var_29672_17_non_const_vy2 = ((((__cuda_local_var_29663_24_non_const_fv)[1]).vy) - (((__cuda_local_var_29663_24_non_const_fv)[1]).y));
# 119 "kernel.cu"
__cuda_local_var_29668_17_non_const_ret = (_Z18gen_model_paramGPUiiiiiiiiPf((((__cuda_local_var_29663_24_non_const_fv)[0]).x), (((__cuda_local_var_29663_24_non_const_fv)[0]).y), __cuda_local_var_29669_17_non_const_vx1, __cuda_local_var_29670_17_non_const_vy1, (((__cuda_local_var_29663_24_non_const_fv)[1]).x), (((__cuda_local_var_29663_24_non_const_fv)[1]).y), __cuda_local_var_29671_17_non_const_vx2, __cuda_local_var_29672_17_non_const_vy2, __cuda_local_var_29655_16_non_const_model_param));
# 120 "kernel.cu"
if (__cuda_local_var_29668_17_non_const_ret == 0)
# 120 "kernel.cu"
{
# 121 "kernel.cu"
(__cuda_local_var_29655_16_non_const_model_param[0]) = (-2011.0F);
# 121 "kernel.cu"
}
# 122 "kernel.cu"
}
...
__syncthreads();
# 125 "kernel.cu"
if ((__cuda_local_var_29655_16_non_const_model_param[0]) == (-2011.0F))
# 125 "kernel.cu"
{
# 126 "kernel.cu"
goto __T27;
...
# 133 "kernel.cu"
 int i;
# 133 "kernel.cu"
i = __cuda_local_var_29645_15_non_const_tx;
# 133 "kernel.cu"
for (; (i < flowvector_count); i += (blockDim.x))
# 133 "kernel.cu"
{
# 134 "kernel.cu"
 flowvector __cuda_local_var_29690_24_non_const_fvreg;
# 134 "kernel.cu"
__cuda_local_var_29690_24_non_const_fvreg = (flowvectors[i]);
# 135 "kernel.cu"
__cuda_local_var_29649_11_non_const_vx_error = ((float)(((__cuda_local_var_29690_24_non_const_fvreg.x) + (((int)(__float2int_rz(((float)((((float)(__cuda_local_var_29690_24_non_const_fvreg.x)) - (__cuda_local_var_29655_16_non_const_model_param[0])) * (__cuda_local_var_29655_16_non_const_model_param[2])))))) - ((int)(__float2int_rz(((float)((((float)(__cuda_local_var_29690_24_non_const_fvreg.y)) - (__cuda_local_var_29655_16_non_const_model_param[1])) * (__cuda_local_var_29655_16_non_const_model_param[3])))))))) - (__cuda_local_var_29690_24_non_const_fvreg.vx)));
# 138 "kernel.cu"
__cuda_local_var_29649_21_non_const_vy_error = ((float)(((__cuda_local_var_29690_24_non_const_fvreg.y) + (((int)(__float2int_rz(((float)((((float)(__cuda_local_var_29690_24_non_const_fvreg.y)) - (__cuda_local_var_29655_16_non_const_model_param[1])) * (__cuda_local_var_29655_16_non_const_model_param[2])))))) + ((int)(__float2int_rz(((float)((((float)(__cuda_local_var_29690_24_non_const_fvreg.x)) - (__cuda_local_var_29655_16_non_const_model_param[0])) * (__cuda_local_var_29655_16_non_const_model_param[3])))))))) - (__cuda_local_var_29690_24_non_const_fvreg.vy)));
# 141 "kernel.cu"
if (((fabsf(__cuda_local_var_29649_11_non_const_vx_error)) >= ((float)error_threshold)) || ((fabsf(__cuda_local_var_29649_21_non_const_vy_error)) >= ((float)error_threshold)))
# 141 "kernel.cu"
{
# 142 "kernel.cu"
__cuda_local_var_29650_9_non_const_outlier_local_count++;
# 143 "kernel.cu"
}
# 144 "kernel.cu"
}
...
# 146 "kernel.cu"
_Z9atomicAddPii((__cuda_local_var_29634_10_non_const_outlier_block_count + 0), __cuda_local_var_29650_9_non_const_outlier_local_count);
# 151 "kernel.cu"
__syncthreads();
# 152 "kernel.cu"
if (__cuda_local_var_29645_15_non_const_tx == 0)
...
{
# 155 "kernel.cu"
if (((float)(__iAtomicAdd((__cuda_local_var_29634_10_non_const_outlier_block_count + 0), 0))) < (((float)flowvector_count) * convergence_threshold))
# 155 "kernel.cu"
{
# 156 "kernel.cu"
 int __cuda_local_var_29712_21_non_const_index;
# 156 "kernel.cu"
__cuda_local_var_29712_21_non_const_index = (__iAtomicAdd(g_out_id, 1));
# 157 "kernel.cu"
(outliers_candidate[__cuda_local_var_29712_21_non_const_index]) = (__iAtomicAdd((__cuda_local_var_29634_10_non_const_outlier_block_count + 0), 0));
# 158 "kernel.cu"
(model_candidate[__cuda_local_var_29712_21_non_const_index]) = iter;
# 159 "kernel.cu"
}
# 167 "kernel.cu"
}
